...
public class CapsLicProviderLoginTest extends BaseConfiguration {
	...
	public void verifyCAPSLogin() {
		...
		//capsLogin.loginCaps(prop.getProperty("LicProviderEmail"), prop.getProperty("LicProviderpwd"));
		capsLogin.loginCaps(prop.getProperty("ProdInfProviderEmail"), prop.getProperty("ProdInfProviderpwd"));
